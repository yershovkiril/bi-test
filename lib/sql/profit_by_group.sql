SELECT date_trunc('month',t1.date)::date    as year_month,
       sum(t1.price*t1.quantity*t2.rate)    as profit
       FROM sales                   as t1
       ...
       GROUP BY year_month, t1.product_id
       HAVING sum(t1.quantity) = %{count_sales}